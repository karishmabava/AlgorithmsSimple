...
int main(){
    ...
    // This question simply requires to find the maximum first and then 
    // The number of occurence of that maximum number
   ...
   // Now we need to find the occurence of that number
    int count=0;
    for(int i=0; i<n; i++){
        if(max == height[i])  
           count++; 
